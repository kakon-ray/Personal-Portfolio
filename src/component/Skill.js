                    ...
                    <div class="block p-6 rounded-lg shadow-lg shadow-stone-500 bg-pink-600-100 max-w-lg ml-6 mb-10">
                      <div>
                        ...
                        <p class="font-medium text-pink-600 hover:text-pink-600-700 py-2 focus:text-pink-600-800 duration-300 transition ease-in-out text-sm">
                          Northern University Business & Technology / 2020 -
                          2023
                        </p>
                      </div>
                  ...
                  <Pulse>
                    <div class="block p-6 rounded-lg shadow-lg shadow-stone-500 bg-pink-600-100 max-w-lg ml-6 mb-10">
                      <div>
                        ...
                        <p class="font-medium text-pink-600 hover:text-pink-600-700 py-2 focus:text-pink-600-800 duration-300 transition ease-in-out text-sm">
                          Khulna University of Engineering & Technology / 2021 -
                          2022
                        </p>
                      </div>
                      <p class="text-pink-600-700 mb-6">
                  ...
                  <Pulse>
                    <div class="block p-6 rounded-lg shadow-lg shadow-stone-500 bg-pink-600-100 max-w-lg ml-6 mb-10">
                      <div>
                        ...
                        <p class="font-medium text-pink-600 hover:text-pink-600-700 py-2 focus:text-pink-600-800 duration-300 transition ease-in-out text-sm">
                          Programming Hero / 2022(January) - 2022(Jun)
                        </p>
                      </div>
                      <p class="text-pink-600-700 mb-6">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    ...
                    <div class="block p-6 rounded-lg shadow-lg shadow-stone-500 bg-pink-600-100 max-w-lg ml-6 mb-10">
                      <div>
                        ...
                        <p class="text-pink-600-700 mb-6">
                          ...
                          elementum Lorem ipsum dolor sit amet, consectetur
                          adipiscing elit.
                        </p>
                      </div>
                      ...
                      <div>
                        <a
                          href="/"
                          class="inline-block px-4 m-1 py-1.5 bg-pink-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-pink-600-700 hover:shadow-lg focus:bg-pink-600-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-pink-600-800 active:shadow-lg transition duration-150 ease-in-out"
                        >
                          project-1
                        </a>
                        <a
