...
const Service = () => {
  return (
    <div class="flex justify-center ">
      <div class="block rounded-lg shadow-sm dark:bg-stone-900 bg-white text-gray-700 dark:hover:bg-slate-900 hover:bg-slate-900 shadow-stone-500  dark:text-white  hover:text-white text-center">
        ...
        <div class="p-6 pt-6">
          <h5 class="text-xl font-medium mb-2">Web Application Development</h5>
