            ...
            <div class="grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12">
              <div class="pr-6 py-12 md:pr-12">
                ...
                <p class="text-white mb-2 text-lg">
                  ...
                  and hunger for learning new technologies. I am always ready to
                  deliver my full potential to the company I am committed.Code
                  will be easy to understand, Reusable components, Proper
                  Comments
                </p>
